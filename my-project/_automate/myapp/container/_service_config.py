...
_container_env_prefix = "CONTAINER_MYAPP"
...
myapp_service_configs: Mapping[str, ServiceConfig] = {
    "myapp": ServiceConfig(
        env_files=[
...
for module in MODULES:
    service_name = f"myapp-{to_kebab_case(module)}-service"
    myapp_service_configs[service_name] = ServiceConfig(
        env_files=[
            _app_template_env_file,
            _docker_compose_app_env_file,
