...
Myapp heavily uses dependency inversion and avoids dependency injection on the same time.
...
## Frontend
Myapp's front end serves static files built before runtime (not SSR/Server Side Rendering). That's mean.
