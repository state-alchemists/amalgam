...
from myapp.module.auth.client.auth_client_factory import auth_client
from myapp.module.gateway.subroute.auth import serve_auth_route
from myapp.module.gateway.subroute.library import serve_library_route
