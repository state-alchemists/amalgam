...
APP_AUTH_SUPER_USER_PASSWORD = os.getenv(
    "MYAPP_AUTH_SUPER_USER_PASSWORD", "trim-bell-6064"
)
...
APP_AUTH_SECRET_KEY = os.getenv("MYAPP_AUTH_SECRET_KEY", "weak-foam-9053")
...
APP_LIBRARY_BASE_URL = os.getenv("MYAPP_LIBRARY_BASE_URL", "http://localhost:3003")
