    ...
    config=LocalChartOpts(
        ...
        values = {
            ...
            "auth": {
                ...
                "tls": {
                    "autoGenerated": os.getenv('AUTH_TLS_AUTOGENERATED', 'False'),
                    "caCertificate": os.getenv('AUTH_TLS_CACERTIFICATE', ''),
                    "enabled": os.getenv('AUTH_TLS_ENABLED', 'False'),
                    "existingSecret": os.getenv('AUTH_TLS_EXISTINGSECRET', ''),
                    "existingSecretFullChain": os.getenv('AUTH_TLS_EXISTINGSECRETFULLCHAIN', 'False'),
                    "failIfNoPeerCert": os.getenv('AUTH_TLS_FAILIFNOPEERCERT', 'True'),
            ...
            "clustering": {
                ...
                "enabled": os.getenv('CLUSTERING_ENABLED', 'True'),
                "forceBoot": os.getenv('CLUSTERING_FORCEBOOT', 'False'),
                "partitionHandling": os.getenv('CLUSTERING_PARTITIONHANDLING', 'autoheal'),
                "rebalance": os.getenv('CLUSTERING_REBALANCE', 'False')
            },
            "command": [],
            "commonAnnotations": {},
            ...
            "extraSecrets": {},
            "extraSecretsPrependReleaseName": os.getenv('EXTRASECRETSPREPENDRELEASENAME', 'False'),
            "extraVolumeMounts": [],
            "extraVolumes": [],
            ...
            "ingress": {
                "annotations": {},
                "enabled": os.getenv('INGRESS_ENABLED', 'False'),
                "extraHosts": [],
                "extraRules": [],
                "extraTls": [],
                ...
                "secrets": [],
                "selfSigned": os.getenv('INGRESS_SELFSIGNED', 'False'),
                "tls": os.getenv('INGRESS_TLS', 'False')
            },
            "initContainers": [],
            "kubeVersion": os.getenv('KUBEVERSION', ''),
            "ldap": {
                "enabled": os.getenv('LDAP_ENABLED', 'False'),
                "port": os.getenv('LDAP_PORT', '389'),
                "servers": [],
                "tls": {
                    "enabled": os.getenv('LDAP_TLS_ENABLED', 'False')
                },
                "user_dn_pattern": os.getenv('LDAP_USER_DN_PATTERN', 'cn=${username},dc=example,dc=org')
            },
            "livenessProbe": {
                "enabled": os.getenv('LIVENESSPROBE_ENABLED', 'True'),
                "failureThreshold": os.getenv('LIVENESSPROBE_FAILURETHRESHOLD', '6'),
                "initialDelaySeconds": os.getenv('LIVENESSPROBE_INITIALDELAYSECONDS', '120'),
                "periodSeconds": os.getenv('LIVENESSPROBE_PERIODSECONDS', '30'),
                "successThreshold": os.getenv('LIVENESSPROBE_SUCCESSTHRESHOLD', '1'),
                "timeoutSeconds": os.getenv('LIVENESSPROBE_TIMEOUTSECONDS', '20')
            },
            "loadDefinition": {
                "enabled": os.getenv('LOADDEFINITION_ENABLED', 'False'),
                "existingSecret": os.getenv('LOADDEFINITION_EXISTINGSECRET', '')
            },
            "logs": os.getenv('LOGS', '-'),
            "maxAvailableSchedulers": os.getenv('MAXAVAILABLESCHEDULERS', ''),
            "memoryHighWatermark": {
                "enabled": os.getenv('MEMORYHIGHWATERMARK_ENABLED', 'False'),
            ...
            "metrics": {
                ...
                "prometheusRule": {
                    "additionalLabels": {},
                    "enabled": os.getenv('METRICS_PROMETHEUSRULE_ENABLED', 'False'),
            ...
            "pdb": {
                "create": os.getenv('PDB_CREATE', 'False'),
                "maxUnavailable": os.getenv('PDB_MAXUNAVAILABLE', ''),
                "minAvailable": os.getenv('PDB_MINAVAILABLE', '1')
            },
            "persistence": {
                "accessMode": os.getenv('PERSISTENCE_ACCESSMODE', 'ReadWriteOnce'),
                "annotations": {},
                "enabled": os.getenv('PERSISTENCE_ENABLED', 'True'),
            ...
            "podSecurityContext": {
                "enabled": os.getenv('PODSECURITYCONTEXT_ENABLED', 'True'),
                "fsGroup": os.getenv('PODSECURITYCONTEXT_FSGROUP', '1001'),
                "runAsUser": os.getenv('PODSECURITYCONTEXT_RUNASUSER', '1001')
            },
            "priorityClassName": os.getenv('PRIORITYCLASSNAME', ''),
            "rbac": {
                "create": os.getenv('RBAC_CREATE', 'True')
            },
            "readinessProbe": {
                "enabled": os.getenv('READINESSPROBE_ENABLED', 'True'),
                "failureThreshold": os.getenv('READINESSPROBE_FAILURETHRESHOLD', '3'),
                "initialDelaySeconds": os.getenv('READINESSPROBE_INITIALDELAYSECONDS', '10'),
                "periodSeconds": os.getenv('READINESSPROBE_PERIODSECONDS', '30'),
                "successThreshold": os.getenv('READINESSPROBE_SUCCESSTHRESHOLD', '1'),
                "timeoutSeconds": os.getenv('READINESSPROBE_TIMEOUTSECONDS', '20')
            },
            "replicaCount": os.getenv('REPLICACOUNT', '1'),
            "resources": {
                "limits": {},
                "requests": {}
            },
            ...
            "service": {
                ...
                "distPort": os.getenv('SERVICE_DISTPORT', '25672'),
                "distPortEnabled": os.getenv('SERVICE_DISTPORTENABLED', 'True'),
                "distPortName": os.getenv('SERVICE_DISTPORTNAME', 'dist'),
                "epmdNodePort": os.getenv('SERVICE_EPMDNODEPORT', ''),
                "epmdPortEnabled": os.getenv('SERVICE_EPMDPORTENABLED', 'True'),
                ...
                "managerPort": os.getenv('SERVICE_MANAGERPORT', '15672'),
                "managerPortEnabled": os.getenv('SERVICE_MANAGERPORTENABLED', 'True'),
                "managerPortName": os.getenv('SERVICE_MANAGERPORTNAME', 'http-stats'),
                "metricsNodePort": os.getenv('SERVICE_METRICSNODEPORT', ''),
                "metricsPort": os.getenv('SERVICE_METRICSPORT', '9419'),
                "metricsPortName": os.getenv('SERVICE_METRICSPORTNAME', 'metrics'),
                "nodePort": os.getenv('SERVICE_NODEPORT', ''),
                "port": os.getenv('SERVICE_PORT', '5672'),
                "portEnabled": os.getenv('SERVICE_PORTENABLED', 'True'),
                "portName": os.getenv('SERVICE_PORTNAME', 'amqp'),
                "tlsNodePort": os.getenv('SERVICE_TLSNODEPORT', ''),
                "tlsPort": os.getenv('SERVICE_TLSPORT', '5671'),
                "tlsPortName": os.getenv('SERVICE_TLSPORTNAME', 'amqp-ssl'),
                "type": os.getenv('SERVICE_TYPE', 'ClusterIP')
            },
            "serviceAccount": {
                "automountServiceAccountToken": os.getenv('SERVICEACCOUNT_AUTOMOUNTSERVICEACCOUNTTOKEN', 'True'),
                "create": os.getenv('SERVICEACCOUNT_CREATE', 'True'),
                "name": os.getenv('SERVICEACCOUNT_NAME', '')
            },
            "sidecars": [],
            "statefulsetLabels": {},
            "terminationGracePeriodSeconds": os.getenv('TERMINATIONGRACEPERIODSECONDS', '120'),
            "tolerations": [],
            "topologySpreadConstraints": [],
            "ulimitNofiles": os.getenv('ULIMITNOFILES', '65536'),
