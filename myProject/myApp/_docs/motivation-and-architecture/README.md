...
This is what `MyApp` tries to aim for.
...
`MyApp` lets you have a straightforward development experience like building a simple monolith. But you always know that `MyApp`` is ready for microservices.
