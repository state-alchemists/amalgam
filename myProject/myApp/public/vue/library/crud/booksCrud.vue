    ...
    export default {
        ...
        methods: {
            ...
            async _getRow(id) {
                ...
                throw new Error(appHelper.getResponseErrorMessage(response, `Cannot get book ${id}`));
            },
            ...
            async _insertRow(row) {
                ...
                throw new Error(appHelper.getResponseErrorMessage(response, `Cannot create book ${id}`));
            },
            ...
            async _updateRow(id, row) {
                ...
                throw new Error(appHelper.getResponseErrorMessage(response, `Cannot update book ${id}`));
            },
            ...
            async _deleteRow(id) {
                ...
                throw new Error(appHelper.getResponseErrorMessage(response, `Cannot delete book ${id}`));
            },
            ...
            async confirmDelete(id) {
                try {
                    const confirmation = await appHelper.confirm(`Are you sure to delete book ${id}?`);
                    if (!confirmation) {
                        return;
                    }
