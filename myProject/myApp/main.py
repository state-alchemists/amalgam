...
from library import (
    register_library_route_handler, register_library_event_handler, register_library_rpc_handler
)
...
if enable_library_module:
    ...
    if enable_route_handler:
        register_library_route_handler(app, mb, rpc, auth_service, menu_service, page_template, enable_ui, enable_api)
    if enable_event_handler:
