...
To generate `MyApp`, you can use the following command using [Zaruba](https://github.com/state-alchemists/zaruba):
...
Zaruba also allows you to add custom resources into `MyApp`. For this to work, you need to follow a few conventions:
...
You can run the `myApp` unit test by invoking the following command:
